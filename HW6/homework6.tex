...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \caption{2b. Final learned value function and policy plots for $ct = 0.01, 0.001, 0.0001$ respectively}
    \end{figure}

    \item[3.] For policy iteration, the number of iterations is lower until the algorithm converges, the time per iteration is smaller, and therefore the overall runtime is faster when compared to value iteration.
    \item[4.]
    ...
    \begin{figure}[h!]
        ...
        \includegraphics[width=0.5\textwidth]{HW6/Value_3.png}
        \includegraphics[width=0.5\textwidth]{HW6/Value_4.png}
        \caption{4. Policy Iteration plots for $\gamma = 0.6, 0.7, 0.8, 0.9$ respectively}
    \end{figure}
    \begin{figure}[h!]
        \includegraphics[width=0.5\textwidth]{HW6/Value_1.png}
        \includegraphics[width=0.5\textwidth]{HW6/Value_2.png}
